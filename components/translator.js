...
// Dictionaries for translations
    ...
    this.britishDict = { ...britishOnly, ...reverseDict(americanToBritishSpelling) };
    this.americanTitles = americanToBritishTitles;
    this.britishTitles = reverseDict(americanToBritishTitles);
  }

  toBritishEnglish(text) {
// American-style time to British-style time    
...
// British-style time to American-style time    
    const timeRegex = /([1-9]|1[012])\.[0-5][0-9]/g;
...
// Search for indivitual word matches and add'em to the matchesMap object
